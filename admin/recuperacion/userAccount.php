<?php
/*
Este archivo controla el registro, el login, el olvidé mi contraseña y la petición de
reseteo de contraseña. Este script cuenta con dos peticiones forgotSubmit y resetSubmit.
 También, la funcionalidad del envío de email se ha añadido a la petición de forgotSubmit
 para enviar el email con el enlace de reseteo de contraseña al usuario.
*/
