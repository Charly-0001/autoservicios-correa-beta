    ...
    <?php if($row_buscaprocuct>0){?>
      <?php do { ?>
          <div class="producto">
            ...
            <div class="btn">
              <a href="productos.php?id=<?php echo base64_encode($row_buscaprocuct['Id']); ?>" class="btn-abrir-popup-edit" id="btn-abrir-popup">
                <i class="fas fa-edit" style="float:left;"></i></a>
              <a href="producto_delete.php?Id=<?php echo base64_encode($row_buscaprocuct['Id']); ?>"onClick="javascript:return eliminar();"><i class="fas fa-trash" style="color:red; float: right;"></i> </a>
            </div>
          </div>
      ...
      <?php if ($totalRows_productos > 0) { // muestra productos cuando la consulta es mayor a cero
        ...
        <?php do { ?>
          <div class="producto">
            ...
            <div class="btn">
              <a href="productos.php?id=<?php echo base64_encode($row_productos['Id']); ?>" class="btn-abrir-popup-edit" id="btn-abrir-popup">
                <i class="fas fa-edit" style="float:left;"></i></a>
              <a href="producto_delete.php?Id=<?php echo base64_encode($row_productos['Id']); ?>"onClick="javascript:return eliminar();"><i class="fas fa-trash" style="color:red; float: right;"></i> </a>
            </div>
          </div>
